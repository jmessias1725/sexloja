...
void tela_cadastro_loja::on_tb_menos_telefone_clicked()
{
...
void tela_cadastro_loja::definir_mascara_telefone(){
    std::string telefone;
...
void tela_cadastro_loja::adicionar_telefone(){
    bool ja_cadastrado;
    ja_cadastrado = false;
    std::string telefone;
...
void tela_cadastro_loja::cancelar_telefone(){
...
void tela_cadastro_loja::on_le_cep_editingFinished(){
    aux_cep = new cep;
    bool possui_cep;
...
void tela_cadastro_loja::on_cb_estado_currentIndexChanged(int index)
{
...
void tela_cadastro_loja::on_btn_cancelar_clicked()
{
    this->close();
}

void tela_cadastro_loja::on_btn_confirmar_clicked()
{
    if((ui->le_nome->text().toStdString()!="")&&(lista_telefone.size()>0)){
        cad_loja = new loja(ui->le_cnpj->text(),ui->le_razao_social->text(),
                            ui->le_nome->text(),lista_telefone,lista_operadora,
...
void tela_cadastro_loja::closeEvent( QCloseEvent * event ){
