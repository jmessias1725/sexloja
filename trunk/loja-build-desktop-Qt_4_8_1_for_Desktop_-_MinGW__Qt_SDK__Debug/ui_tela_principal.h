...
**
** Created: Mon 10. Sep 15:37:22 2012
...
public:
    ...
    void setupUi(QMainWindow *tela_principal)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/img/Usuario.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/img/caixa.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/img/fornecedor.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/img/estoque2.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/img/cadastrar_fornecedor.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/img/cadastrar_produto.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/img/vender.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/img/adiciona_clientes.png"), QSize(), QIcon::Normal, QIcon::Off);
        Cadastrar_cliente->setIcon(icon8);
        botao_sair = new QAction(tela_principal);
        botao_sair->setObjectName(QString::fromUtf8("botao_sair"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/img/sair.png"), QSize(), QIcon::Normal, QIcon::Off);
