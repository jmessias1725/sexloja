...
**
** Created: Wed 7. Nov 14:07:47 2012
...
public:
    ...
    void setupUi(QDialog *tela_pagamento)
    {
        ...
        gb_forma_pagamento->setGeometry(QRect(5, 0, 190, 111));
        QFont font;
        ...
        le_dinheiro->setGeometry(QRect(100, 20, 85, 25));
        QFont font2;
        ...
        btn_confirmar->setGeometry(QRect(8, 195, 90, 25));
        ...
        frame->setGeometry(QRect(0, 110, 200, 80));
        ...
        le_total_pagar->setGeometry(QRect(105, 3, 85, 24));
        QFont font4;
        ...
        le_total_pagar->setMaxLength(12);
        ...
        le_total_pago->setGeometry(QRect(105, 28, 85, 24));
    ...
    void retranslateUi(QDialog *tela_pagamento)
    {
        ...
        le_dinheiro->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_dinheiro->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
        le_cartao->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_cartao->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
        le_cheque->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_cheque->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
        ...
        le_total_pagar->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_total_pagar->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
        le_total_pago->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_total_pago->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
        le_troco->setInputMask(QApplication::translate("tela_pagamento", "R$ xxxxxxxxx; ", 0, QApplication::UnicodeUTF8));
        le_troco->setText(QApplication::translate("tela_pagamento", "R$ ", 0, QApplication::UnicodeUTF8));
