...
**
** Created: Sun 16. Sep 22:55:10 2012
...
public:
    ...
    void setupUi(QMainWindow *tela_clientes)
    {
        ...
        le_codigo->setGeometry(QRect(50, 20, 70, 20));
        ...
        le_nome->setGeometry(QRect(160, 20, 425, 20));
        ...
        le_cpf->setGeometry(QRect(40, 50, 100, 20));
        ...
        lb_nome->setGeometry(QRect(124, 20, 35, 20));
