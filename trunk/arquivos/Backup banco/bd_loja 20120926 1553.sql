...
CREATE TABLE `loja` (
  ...
  `cnpj` int(18) unsigned DEFAULT NULL,
  ...
  `logomarca` longblob,
  `formato_logo` varchar(4) DEFAULT NULL,
  PRIMARY KEY (`id_loja`)
...
INSERT INTO `loja` (`id_loja`,`cnpj`,`razao_social`,`nome`,`cep`,`rua`,`numero`,`bairro`,`cidade`,`uf`,`estado`,`logomarca`,`formato_logo`) VALUES 
