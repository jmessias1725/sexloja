...
void tela_editar_cliente::definir_icone_janela(QPixmap logo){
    logomarca = logo;
...
void tela_editar_cliente::definir_dados_cliente(cliente *cad_cliente){
    ...
    lista_operadora = cad_cliente->retorna_lista_operadora();
    ...
    ui->te_comentario->setText(cad_cliente->retornar_comentario());
    ui->cb_estado->setCurrentIndex(funcoes.retorna_id_estado(cad_cliente->retorna_sigla_estado().toStdString()));
...
void tela_editar_cliente::on_tb_menos_email_clicked()
{
...
void tela_editar_cliente::on_tb_mais_email_clicked()
{
    ...
    Qdialog_email->setWindowIcon(logomarca);
...
void tela_editar_cliente::adicionar_email(){
...
void tela_editar_cliente::cancelar_email(){
    if (le_email->text()=="")
    {
        Qdialog_email->close();
    }
...
void tela_editar_cliente::on_tb_mais_telefone_clicked()
{
    QLabel *lb_telefone;
    QLabel *lb_operadora;
...
void tela_editar_cliente::on_tb_menos_telefone_clicked()
{
...
void tela_editar_cliente::definir_mascara_telefone(){
    std::string telefone;
...
void tela_editar_cliente::adicionar_telefone(){
    bool ja_cadastrado;
    ja_cadastrado = false;
    std::string telefone;
...
void tela_editar_cliente::cancelar_telefone(){
...
void tela_editar_cliente::on_cb_estado_currentIndexChanged(int index)
{
...
void tela_editar_cliente::on_btn_cancelar_clicked()
{
    this->close();
}
