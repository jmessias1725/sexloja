/********************************************************************************
** Form generated from reading UI file 'tela_receita_avulsa.ui'
**
...
#ifndef UI_TELA_RECEITA_AVULSA_H
#define UI_TELA_RECEITA_AVULSA_H
...
public:
    ...
    void setupUi(QDialog *tela_receita_avulsa)
    {
        if (tela_receita_avulsa->objectName().isEmpty())
            tela_receita_avulsa->setObjectName(QString::fromUtf8("tela_receita_avulsa"));
        tela_receita_avulsa->resize(405, 230);
        verticalLayout = new QVBoxLayout(tela_receita_avulsa);
        verticalLayout->setSpacing(5);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(5, 3, 5, 5);
        gb_dados_despesa = new QGroupBox(tela_receita_avulsa);
        ...
        gb_descricao = new QGroupBox(tela_receita_avulsa);
        ...
        btn_confirmar = new QPushButton(tela_receita_avulsa);
        ...
        btn_cancelar = new QPushButton(tela_receita_avulsa);
        ...
        retranslateUi(tela_receita_avulsa);

        QMetaObject::connectSlotsByName(tela_receita_avulsa);
    } // setupUi

    void retranslateUi(QDialog *tela_receita_avulsa)
    {
        tela_receita_avulsa->setWindowTitle(QApplication::translate("tela_receita_avulsa", "Cadastrar receita", 0, QApplication::UnicodeUTF8));
        gb_dados_despesa->setTitle(QApplication::translate("tela_receita_avulsa", "Dados da despesa", 0, QApplication::UnicodeUTF8));
        lb_dia->setText(QApplication::translate("tela_receita_avulsa", "Data:", 0, QApplication::UnicodeUTF8));
        lb_valor->setText(QApplication::translate("tela_receita_avulsa", "Valor:", 0, QApplication::UnicodeUTF8));
        lb_status->setText(QApplication::translate("tela_receita_avulsa", "Status:", 0, QApplication::UnicodeUTF8));
        cb_status->clear();
        cb_status->insertItems(0, QStringList()
         << QApplication::translate("tela_receita_avulsa", "Paga", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("tela_receita_avulsa", "Aberta", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("tela_receita_avulsa", "Atrasada", 0, QApplication::UnicodeUTF8)
        );
        gb_descricao->setTitle(QApplication::translate("tela_receita_avulsa", "Descri\303\247\303\243o", 0, QApplication::UnicodeUTF8));
        btn_confirmar->setText(QApplication::translate("tela_receita_avulsa", "Confirmar", 0, QApplication::UnicodeUTF8));
        btn_cancelar->setText(QApplication::translate("tela_receita_avulsa", "Cancelar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class tela_receita_avulsa: public Ui_tela_receita_avulsa {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TELA_RECEITA_AVULSA_H
